...
router.get('/cuentas/clientes/listarA',[auth0, userProfile],  CuentasController.getCuentasCA);
router.get('/cuentas/proveedores/listarA/:last?',[auth0, userProfile],  CuentasController.getCuentasPA);
router.get('/cuentas/propietarios/listarA/:last?',[auth0, userProfile],  CuentasController.getPropietariosA);
