...
var controller ={ 
    update: (req, res) => {
              ...
              try{
                ...
                fechaMX.setUTCHours(fechaMX.getUTCHours() - 6);
                estado.timestamp=fechaMX;
                estado.findOneAndUpdate({_id: estadoID}, params, {new:true}, (err, estadoUpdated) => {
                if(err){
                ...
                return res.status(200).send({estadoUpdated});
             });             
    },    
