...
// const FILE_PATH = "C:\\Backend\\Master\\upload\\Layout\\XhVg_i9MqzXZ-D3QqAkdTIQi.xlsx";
...
var controller = {
  saveFile: async (req, res) => {
    ...
    var file_name = req.files.file_path.originalFilename;
          ...
          Object.keys(FILAS).map((fila, index) => {
            ...
            switch (fila.substr(0, 1)) {
              ...
              case "J":
                ...
                transferencia.timestamp = fechaMX;
  ...
  getAllDispersion: async (req, res) => {
    ...
    const dispersiones = Dispersion.find({ estatus: true })
          ...
          .then(respuesta_stp => {
            ...
            if (respuesta_stp.data.resultado.descripcionError) {
              Transferencia.findOneAndUpdate(
                ...
                {
                  descripcionError:
                    respuesta_stp.data.resultado.descripcionError,
