...
router.get(
  '/tipos_pagos/listarA/:last?',
  auth0,
  TiposPagosController.getTiposPagosA
);
router.get(
  '/tipos_pagos/listarI/:last?',
  [auth0],
  TiposPagosController.getTiposPagosI
);
router.get(
  '/tipos_pagos/buscar/:id',
  [auth0],
  TiposPagosController.getTipoPago
);
